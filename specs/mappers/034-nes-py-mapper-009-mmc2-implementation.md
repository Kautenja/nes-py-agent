...
- Register mapper 9 in the native mapper registry so `_native.is_mapper_supported` and Python `NESEnv` validation accept mapper 9 only after the C++ mapper is wired.
