...
- [ ] The build backend remains `setuptools.build_meta`, with explicit setuptools configuration for package discovery and `gym_zelda_1/_roms/*.nes` package data.
- [ ] The console script `gym_zelda_1 = gym_zelda_1._app.cli:main` is installed and still exposes help successfully.
